<x-admin-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <a href="{{ route('admin.wali.index') }}"
            class="relative bg-white dark:bg-slate-800 rounded-xl p-6 shadow-sm border border-slate-200/60 dark:border-slate-700 overflow-hidden group hover:shadow-lg hover:shadow-orange-500/20 transition-all">
            <div
