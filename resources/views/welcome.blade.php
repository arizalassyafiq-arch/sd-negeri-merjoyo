<x-main-layout>
    ...
    <div class="relative pt-40 pb-60 overflow-hidden min-h-[90vh] flex items-center">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div class="space-y-6">
                    ...
                    <h1 class="text-4xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight">
                        Mari Bergabung <br />
                        <span class="text-green-800 dark:text-slate-800">Bersama Kami</span>
                    </h1>
        ...
        <div class="absolute bottom-0 sm:bottom-auto sm:top-1/2 sm:left-1/2 sm:-translate-x-1/2  w-full sm:w-125 h-[85vh] sm:h-162.5 bg-white dark:bg-surface-dark sm:rounded-2xl shadow-2xl flex flex-col overflow-hidden transition-all duration-300 transform translate-y-full sm:translate-y-0 sm:scale-95 opacity-0"
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-1.5">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 font-medium">Forum Wali Murid & Sekolah
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div
                ...
                <div class="flex justify-center">
                    <span
                        class="bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-[10px] py-1 px-3 rounded-full font-medium shadow-sm">Hari
                        Ini</span>
                </div>
                <div class="flex gap-3 max-w-[85%]">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <div
                            ...
                            <p class="text-sm text-gray-800 dark:text-gray-200">Selamat pagi bapak/ibu guru. Apakah
                                untuk kegiatan outing class besok anak-anak perlu membawa bekal tambahan?</p>
                        </div>
